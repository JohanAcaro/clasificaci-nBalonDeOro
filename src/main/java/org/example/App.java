...
public class App 
{
    ...
    private static void importarCSV(String nombreArchivo, String nombreArchivo2) {
        ...
        try {
            ...
            int batchSize = 20;
            String sql = "INSERT INTO equipos (cod_equipo ,nombre, liga) VALUES (?, ?, ?)";
            PreparedStatement sentencia = con.prepareStatement(sql);

            BufferedReader br = new BufferedReader(new FileReader("target/archivosCSV/"+nombreArchivo2));
            String linea;
            int count= 0;
            System.out.println("\n---------Equipos----------");
            while ((linea = br.readLine()) != null) {
                ...
                sentencia.setString(1, codEquipo);
                sentencia.setString(2, nombre);
                sentencia.setString(3, liga);
            ...
            con.setAutoCommit(false);
            int batchSize2 = 20;
            String sql2 = "INSERT INTO balon_oro (id ,nombre, cod_equipo, votos) VALUES (?, ?, ?, ?)";
            ...
            BufferedReader br2 = new BufferedReader(new FileReader("target/archivosCSV/"+nombreArchivo));
            String linea2;
            int count2 = 0;
            ...
            while ((linea2 = br2.readLine()) != null) {
                ...
                sentencia2.setString(3, codEquipo);
                sentencia2.setInt(4, votos);

                sentencia2.addBatch();

                if (count2 % batchSize2 == 0) {
                    sentencia2.executeBatch();
                }
            }
            //Cierro el archivo
            br2.close();
